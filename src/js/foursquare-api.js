const getBars = function(latlon, rad) {
  ...
  const url = `${FOURSQUARE_URL}client_id=${CLIENT_ID}&client_secret=${CLIENT_SECRET}&ll=${latlon}&radius=${rad}&intent=browse&section=drinks&limit=10&v=20180505&offset=0`;
